...
if(isset($_POST['btn-submit']))
{
	...
	if($stmt->rowCount() == 1)
	{
		...
		$message = "
				...
				<br /> br />
				<a href='http://http://localhost/php/PDO/codingcage.com/login-registration-email-verification-forgot-password/resetpass.php?id=$id&code=$code'>click here to reset your password</a>
				<br /> <br />
				thank you :)
		";
